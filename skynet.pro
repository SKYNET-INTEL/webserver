...
exists($${OUT_PWD}/qgroundcontrol.pro) {
    error("You must use shadow build (e.g. mkdir build; cd build; qmake ../skynet.pro).")
}
...
QGC_APP_NAME        = "SKYNET COMPREHENSIVE GCS"
QGC_ORG_NAME        = "DRONES TECH LAB"
QGC_ORG_DOMAIN      = "skynet-intel.in"
QGC_APP_DESCRIPTION = "Open source skynet app provided by skynet dev team"
QGC_APP_COPYRIGHT   = "Copyright (C) 2023 skynet Development Team. All rights reserved."
...
CustomBuild {
    ...
    DEFINES += QGC_APPLICATION_NAME=\"\\\"SKYNET GCS\\\"\"
    DEFINES += QGC_ORG_NAME=\"\\\"SKYNET GCS\\\"\"
    DEFINES += QGC_ORG_DOMAIN=\"\\\"SKEYNET-INTEL\\\"\"
    RESOURCES += \
